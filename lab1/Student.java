...
public class Student extends StudentShort {
    ...
    public Student(int studentId, String lastName, String firstName, String patronymic, String address, String phone) {
        super(studentId, lastName, firstName, patronymic, phone);
        validateAddress(address);
        this.address = address;
    }

    public Student(Student student) {
        this(requireStudent(student).getStudentId(), student.getLastName(), student.getFirstName(), student.getPatronymic(), student.address, student.getPhone());
    }
    ...
    public String toString() {
        String displayedPatronymic = getPatronymic() == null || getPatronymic().isEmpty() ? "не указано" : getPatronymic();
    ...
    public static void main(String[] args) {
        ...
        StudentShort studentAsShort = student;
        System.out.println();
        System.out.println("Полный вывод через ссылку StudentShort:");
        System.out.println(studentAsShort);
    }
}
...
class StudentShort {
    ...
    public StudentShort(StudentShort student) {
        this(requireStudent(student).studentId, student.lastName, student.firstName, student.patronymic, student.phone);
    }

    protected static StudentShort requireStudent(StudentShort student) {
        if (student == null) {
    ...
    public boolean equals(Object object) {
        ...
        StudentShort student = (StudentShort) object;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(studentId, lastName, firstName, patronymic, phone);
    }
